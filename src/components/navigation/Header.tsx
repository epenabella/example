...
const Header = () => <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-transparent text-sm py-3 sm:py-0">
<nav
...
>
  <div className="flex items-center justify-between min-w-[15rem]">
    ...
    <div className="sm:hidden">
      <button
        type="button"
        className="hs-collapse-toggle p-2 inline-flex justify-center items-center gap-2 rounded-md font-medium text-black dark:text-white/[.5] shadow-sm align-middle hover:bg-white/[.1] dark:hover:text-white  transition-all text-sm"
        data-hs-collapse="#navbar-collapse-with-animation"

        aria-controls="navbar-collapse-with-animation"
        aria-label="Toggle navigation"
      >
            <div id='animated-icon1' className="animated-icon1 navbar-collapse-toggle"><span className="bg-black dark:bg-white"></span><span className="bg-black dark:bg-white"></span><span className="bg-black dark:bg-white"></span></div>
      </button>
    </div>
  </div>
  <div
...
//          <a className="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-200 dark:hover:text-gray-300" href="javascript:void(0)">Account</a>
//          <a className="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-200 dark:hover:text-gray-300" href="javascript:void(0)">Work</a>
//          <a className="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-200 dark:hover:text-gray-300" href="javascript:void(0)">Blog</a>
//          <a
//     className="hs-dark-mode-active:hidden block hs-dark-mode group flex items-center text-gray-600 hover:text-blue-600 font-medium dark:text-gray-400 dark:hover:text-gray-500"
//     href="javascript:void(0)"
//     data-hs-theme-click-value="dark"
